...
const Payment = () => {
  ...
  console.log('Orders with dates:', orders.map(o => ({ id: o.id, date: o.date })));

  let filteredOrdersByDate;
  if (timeFilter === 'today') {
    // Hiển thị tất cả đơn hàng khi chọn "Hôm nay"
  ...
  console.log('Filtered Orders:', filteredOrdersByDate);
